...
(ingot :id "i3" :status molten :solo nil :grade 1 :skill cli :heat 0 :max 5 :smelt 0 :proof "cargo test --all 2>&1 | grep -q 'test result: ok'" :work "Run cargo test --all and verify all tests pass with 0 failures")
